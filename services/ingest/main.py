"""
ZTI Ingest Service
Pulls tickets from Zendesk A2A agent and persists to ArangoDB
"""
...
ZENDESK_AGENT_URL = os.getenv("ZENDESK_AGENT_URL", "http://192.168.87.79:10004")
...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting ZTI Ingest Service", agent_url=ZENDESK_AGENT_URL)
    app.state.zendesk_client = ZendeskA2AClient(ZENDESK_AGENT_URL)
